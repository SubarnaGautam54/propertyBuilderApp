package com.trignsoft.propertybuilder.ConstantApis;
...
public class Api {
    ...
    public static final String GET_VIDEOS= "http://"+ROOT_IP_ADDRESS+"/propertyBuilder/uploadVideos/";
    ...
    public static final String GET_APPOINTMENT= "http://"+ROOT_IP_ADDRESS+"/propertyBuilder/get_all_appointments.php";

    public static final String EDIT_PHASE_DEC= "http://"+ROOT_IP_ADDRESS+"/propertyBuilder/test_edit_phase_dec.php";

    public static final String EDIT_PHASE_IMAGES= "http://"+ROOT_IP_ADDRESS+"/propertyBuilder/test_add_edit_phase_images.php";

    public static final String DEACTIVATE_ACCOUNT= "http://"+ROOT_IP_ADDRESS+"/propertyBuilder/deactivate_account.php";

    public static final String Activate_ACCOUNT= "http://"+ROOT_IP_ADDRESS+"/propertyBuilder/activate_account.php";

    public static final String UPDATE_APPOINTMENT_APPROVED= "http://"+ROOT_IP_ADDRESS+"/propertyBuilder/update_appointment_approve.php";

    public static final String REMOVE_PHASE= "http://"+ROOT_IP_ADDRESS+"/propertyBuilder/delete_phase.php";

    public static final String DELETE_COMMENT= "http://"+ROOT_IP_ADDRESS+"/propertyBuilder/delete_comment.php";
    ...
    public static final String EMAIL_CONFIRM = "http://"+ROOT_IP_ADDRESS+"/propertyBuilder/email_verify.php";

    public static final String UPDATE_PASSWORD = "http://"+ROOT_IP_ADDRESS+"/propertyBuilder/update_password.php";
    public static final String CHECK_PHONE = "http://"+ROOT_IP_ADDRESS+"/propertyBuilder/cus_register_phone.php";
